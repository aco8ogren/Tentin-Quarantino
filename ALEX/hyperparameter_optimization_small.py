...
def test_error(HYPERPARAMS,train_til,test_from,test_til): 
    ...
    SEIIRQD_model(HYPERPARAMS = HYPERPARAMS,isSaveRes = True,sv_flnm_np = temp_raw_npy,
                    ...
                    just_train_these_fips = fips,isPlotBokeh = True)
    ...
    score = evaluate_predictions(temp_processed_csv,
                                 test_from,
                                 end_date = test_til,
                                 only_score_these_fips=fips)
    return score
...
if __name__ == '__main__':
    res = gp_minimize(f,                  # the function to minimize
                    ...
                    [
                            ...
                            (50,55),             # D_THRES: If a state does not have more than this number of deaths by train_til, we do not make predictions (or, we make cluster predictions)
...
# %%
    ...
    fig.figure.savefig("Alex/bayesian_optimization_plots/bayesian_optimization_convergence_superior.pdf")
    print(res)
#%%
